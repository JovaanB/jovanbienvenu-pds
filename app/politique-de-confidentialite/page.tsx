    ...
    <main className="relative">
      ...
      <section className="relative z-10 pt-36 pb-12 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <span className="pill-badge mb-4 inline-flex">RGPD</span>
            <h1 className="text-4xl md:text-5xl font-bold text-ink mb-4 leading-tight mt-3">
              Politique de{" "}
              <span className="text-gradient-primary">confidentialité</span>
            </h1>
        ...
        <div className="max-w-3xl mx-auto space-y-6 pt-12">
            ...
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <dl className="space-y-3">
                {[
                  ...
                  >
                    <dt className="text-ink-4 text-sm font-medium w-40 shrink-0">
                      {item.label}
                    </dt>
            ...
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li
                    key={item.field}
                    className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4 py-2 border-b border-border-soft last:border-0"
                  >
                    <div className="flex items-center gap-2 w-56 shrink-0">
                      ...
                      {!item.required && (
                        <span className="text-[10px] px-1.5 py-0.5 rounded bg-bg-alt border border-border-soft text-ink-4">
                          optionnel
                        </span>
                      )}
                    </div>
              ...
              <p className="text-ink-4 text-xs mt-4 leading-relaxed">
          ...
          <FadeIn>
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <ul className="space-y-2 list-disc list-inside text-ink-3 text-sm">
          ...
          <FadeIn>
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <p className="text-ink-3 text-sm leading-relaxed">
                ...
                <span className="text-ink font-medium">3 ans</span> à compter
              ...
              <p className="text-ink-3 text-sm leading-relaxed mt-3">
                ...
                un délai de{" "}
                <span className="text-ink font-medium">12 mois</span>.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <div className="mt-5 p-4 rounded-xl bg-primary/5 border border-primary/15">
                <p className="text-ink-2 text-sm leading-relaxed">
                  ...
                  <span className="text-ink font-medium">30 jours</span>.
                </p>
              </div>
              <p className="text-ink-4 text-xs mt-4 leading-relaxed">
          ...
          <FadeIn>
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              <h2 className="text-ink font-bold text-lg mb-4">6. Cookies</h2>
              <p className="text-ink-3 text-sm leading-relaxed">
                Ce site n&apos;utilise{" "}
                <span className="text-ink font-medium">
          ...
          <FadeIn>
            <div className="rounded-2xl border border-border-warm bg-white shadow-card p-6 md:p-8">
              ...
              <p className="text-ink-3 text-sm leading-relaxed">
                ...
                <span className="text-ink font-medium">HTTPS/TLS</span>. Les
