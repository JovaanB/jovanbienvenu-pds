...
export const metadata: Metadata = buildMetadata({
  title:
    "Référencement local Google My Business — Avesnois | Optimisation fiche GMB 200€",
  description:
    "Optimisation fiche Google My Business dans l'Avesnois à 200€. Apparaissez en 1ère page Google à Fourmies, Maubeuge, Hirson. Résultats en 4 à 8 semaines.",
